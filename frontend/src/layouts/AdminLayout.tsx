...
import { Activity, Key, Settings, LayoutDashboard, MessageSquare } from "lucide-react"
    ...
    <div className="flex min-h-screen w-full bg-background">
      <aside className="w-64 flex-col border-r bg-card flex hidden md:flex">
        <div className="h-16 flex items-center px-6 border-b">
          <div className="font-bold text-lg tracking-tight text-primary">qwen2API 控制台</div>
        </div>
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 flex items-center justify-between px-6 border-b bg-card md:hidden">
           <div className="font-bold text-lg text-primary">qwen2API 控制台</div>
        </header>
